...
public class ExpectCryptoToSubHandler implements InputMessageHandler {
    ...
    public ExpectCryptoToSubHandler(UserDataCache userDataCache, ReplyMessagesService messagesService) {
    ...
    private SendMessage processUsersInput(Message inputMsg) {
        ...
        return messagesService.getReplyMessage(chatId,"Заглушка sub");
    }
}
